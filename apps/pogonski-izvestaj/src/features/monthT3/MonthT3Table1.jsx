...
import MonthT3Row from "./MonthT3Row";
import Table from "@tis/ui/Table";
import Menus from "@tis/ui/Menus";
// import { useSearchParams } from "react-router-dom";

import { useListMonthT3 } from "./useListMonthT3";
...
function MonthT3Table() {
  const { dogadjaji, isLoading, count } = useListMonthT3();
  // const [searchParams] = useSearchParams();

  if (isLoading) return <Spinner />;
  // console.log("Mesecni T3:", dogadjaji);
  ...
  return (
    <Menus>
      <Table columns="0.3fr 0.3fr 0.3fr 0.3fr 1fr 1.6fr 1fr 2.5fr 2.5fr 1.2fr 1.2fr">
        <Table.Header>
          <StackedH>
            <span>Из</span>
            <span>бор</span>
