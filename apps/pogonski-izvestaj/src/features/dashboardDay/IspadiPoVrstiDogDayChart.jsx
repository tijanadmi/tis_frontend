...
function IspadiPoVrstiDogDayChart({ dogadjaji }) {
  ...
  return hasDog ? (
    ...
    <ChartBox>
      <Heading as="h2">Нема испада/кварова</Heading>
    </ChartBox>
  );
  // <ChartBox>
  //   <Heading as="h2">Испади/кварови по врсти догађаја</Heading>
...
IspadiPoVrstiDogDayChart.propTypes = {
...
export default IspadiPoVrstiDogDayChart;
