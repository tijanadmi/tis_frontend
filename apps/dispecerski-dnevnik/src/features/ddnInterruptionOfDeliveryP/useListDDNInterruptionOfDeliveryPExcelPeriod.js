...
import { getListDDNInterruptionOfDeliveryPExcelPeriod } from "../../services/apiDDNInterruptionOfDeliveryP";

export function useListDDNInterruptionOfDeliveryPExcelPeriod() {
...
//   }
  ...
  const {
    ...
    queryKey: ["prekidip", firstDay, lastDay, mrcId],
    queryFn: () => getListDDNInterruptionOfDeliveryPExcelPeriod(firstDay, lastDay, mrcId),
