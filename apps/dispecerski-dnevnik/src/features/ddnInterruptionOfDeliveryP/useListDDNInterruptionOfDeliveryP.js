...
import { getListDDNInterruptionOfDeliveryP } from "../../services/apiDDNInterruptionOfDeliveryP";

export function useListDDNInterruptionOfDeliveryP() {
  ...
  const {
    ...
    queryKey: ["prekidip", month, year, mrcId, page],
    queryFn: () => getListDDNInterruptionOfDeliveryP(month, year, mrcId, page),
  });
